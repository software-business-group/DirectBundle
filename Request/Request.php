...
{
    /**
     * The Symfony request object taken by DirectBundle controller.
     * 
    ...
    public function __construct(HttpRequest $request)
    {
        ...
        $this->rawPost = str_replace(array('[undefined]'), array('null'), $request->getContent());
    ...
    private function parseRawToArray(&$value, &$key)
    {
        ...
        if (is_string($value)) {
            ...
            if ($json) {
                $value = filter_var($json, FILTER_SANITIZE_STRING);
            }
        }
